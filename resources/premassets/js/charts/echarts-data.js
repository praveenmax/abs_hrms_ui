$(function() {
    ...
    if($("#donutChartEcharts").length) {
        ...
        var donutOption = {
            ...
            //     orient: 'vertical',
            //     x: 'left',
            //     data:['Sick Leaves','Casual Leaves','LOP', 'Compensatory Off', 'Flexi Day Off']
            // },
            series: [
                {
                    name:'Leaves',
                    ...
                    data:[
                        {value:234, name:'Sick Leaves'},
                        {value:135, name:'Casual Leaves'},
                        {value:100, name:'LOP'},
                        {value:100, name:'Compensatory Off'},
                        {value:1348, name:'Flexi Day Off'}
                    ]
                },
            ],
